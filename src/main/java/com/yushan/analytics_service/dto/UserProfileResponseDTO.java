...
import com.yushan.analytics_service.enums.Gender;
import com.yushan.analytics_service.enums.UserStatus;
import lombok.Data;

import java.util.Date;

/**
 * DTO for user profile response from user service
 */
@Data
public class UserProfileResponseDTO {
    ...
    // Gamification fields for ranking
    private Integer exp;
